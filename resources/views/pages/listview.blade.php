				...
				<div id="demo" class="box jplist" style="margin: 20px 0 50px 0">
					...
					<div class="list box text-shadow">
						...
						<div class="list-item box">
							...
							<!-- img -->
							<div class="img">
								<img src="css/img/thumbs/calendar-1.jpg" alt="" title=""/>
							</div>
						...
						<div class="list-item box">
							<!-- img -->
							<div class="img">
								<img src="css/img/thumbs/arch-2.jpg" alt="" title=""/>
							</div>
						...
						<div class="list-item box">
							<!-- img -->
							<div class="img">
								<img src="css/img/thumbs/autumn-1.jpg" alt="" title=""/>
							</div>
						...
						<div class="list-item box">
							<!-- img -->
							<div class="img">
								<img src="css/img/thumbs/boats-1.jpg" alt="" title=""/>
							</div>
