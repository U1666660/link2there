<?php
 ...
 function businessinsider () {
  $urlArticles = file_get_contents('https://newsapi.org/v1/articles?source=business-insider-uk&sortBy=latest&apiKey=3329a36068a14512b9acb66f2b8f800a');
     ...
     <div class="list-item box">
      ...
      <!-- data -->
        <div class="block">
          ...
          <span class="grop">Business Insider</span>
          </p>
