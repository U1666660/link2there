<?php
 ...
 function mtvnews () {
  $urlArticles = file_get_contents('https://newsapi.org/v1/articles?source=mtv-news-uk&sortBy=top&apiKey=3329a36068a14512b9acb66f2b8f800a');
